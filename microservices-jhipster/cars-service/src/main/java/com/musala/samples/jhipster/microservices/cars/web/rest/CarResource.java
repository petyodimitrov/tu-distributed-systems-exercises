package com.musala.samples.jhipster.microservices.cars.web.rest;

import com.musala.samples.jhipster.microservices.cars.domain.Car;
import com.musala.samples.jhipster.microservices.cars.repository.CarRepository;
import com.musala.samples.jhipster.microservices.cars.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.musala.samples.jhipster.microservices.cars.domain.Car}.
 */
@RestController
@RequestMapping("/api")
public class CarResource {
    ...
    private static final String ENTITY_NAME = "carsCar";
