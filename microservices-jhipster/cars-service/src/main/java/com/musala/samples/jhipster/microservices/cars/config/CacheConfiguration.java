package com.musala.samples.jhipster.microservices.cars.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("cars");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("cars");
        ...
        config.getMapConfigs().put("com.musala.samples.jhipster.microservices.cars.domain.*", initializeDomainMapConfig(jHipsterProperties));
