package com.musala.samples.jhipster.microservices.dealers.config;
...
@Configuration
@EnableMongoRepositories("com.musala.samples.jhipster.microservices.dealers.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.musala.samples.jhipster.microservices.dealers.config.dbmigrations");
