    ...
    return (
      <div>
        <h2 id="dealer-heading">
          <Translate contentKey="sampleGatewayApp.dealersDealer.home.title">Dealers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sampleGatewayApp.dealersDealer.home.createLabel">Create new Dealer</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {dealerList && dealerList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="sampleGatewayApp.dealersDealer.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('address')}>
                    <Translate contentKey="sampleGatewayApp.dealersDealer.address">Address</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="sampleGatewayApp.dealersDealer.home.notFound">No Dealers found</Translate>
            </div>
          )}
        </div>
