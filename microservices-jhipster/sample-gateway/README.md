...
To build the final jar and optimize the sample_gateway application for production, run:
...
Then navigate to [http://localhost:9180](http://localhost:9180) in your browser.
