package bg.tusofia.fksu.soa.examples.ws.client;
...
public class CinemaClient {
	...
	private static final String NAMESPACE = "http://server.ws.examples.soa.fksu.tusofia.bg/";
	private static final String ENDPOINT_URL = "http://localhost:9999/cinema";
	...
	private static SOAPMessage createMessage(String title, int year) throws SOAPException {
		...
		QName movieInfo = new QName("http://ws.examples.soa.fksu.tusofia.bg/", "getMovieInfo", "e");
	...
	public static void main(String[] args) throws Exception {
		URL wsdl = new URL(ENDPOINT_URL + "?wsdl");

		QName serviceName = new QName(NAMESPACE, "CinemaService");
		Service service = Service.create(wsdl, serviceName);

		QName portName = new QName(NAMESPACE, "CinemaPort");
